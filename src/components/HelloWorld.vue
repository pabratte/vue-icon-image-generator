            ...
            <div class="col-md-6 offset-md-6" >
                <form>
                    ...
                    <div class="form-group">
                            ...
                            <input type="range" v-model="canvas.size" class="custom-range" id="canvasSize" min="100" max="512" step="1">
                            <label>Color:</label>
                            <br>
                    ...
                    <div class="form-group">
                        <label>Name: </label>
                        <v-select :options="fa_icons" v-model="icon.fa_class">
                    ...
                    <h2>Frame</h2>
                    <div class="form-group">
                        <input type="checkbox" v-model="frame.visible">
                        <label>Visible</label>
                        <br>
                        <label>Angle: [{{frame.angle}}deg]</label>
                        <input type="range" v-model="frame.angle" class="custom-range" min="-360" max="360" step="1">
                        <br>
                        <label>Size: [{{frame.size}}%]</label>
                        <input type="range" v-model="frame.size" class="custom-range" min="0" max="100" step="1">
                        <br>
                        <label>Rounded: [{{frame.border_radius}}%]</label>
                        <input type="range" v-model="frame.border_radius" class="custom-range" min="0" max="100" step="1">
                        <label>Color: </label>
                        <br>
